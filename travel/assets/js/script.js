const text = `
My score for task Travel 1 is 100 out of 100.\n
Вёрстка валидная +10 \n
для проверки валидности вёрстки использовала сервис https://validator.w3.org/ \n     
валидной вёрстке соответствует надпись "Document checking completed."\n
